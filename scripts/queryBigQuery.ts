...
const keyFileEnvironmentVariable =
  "EXPENSE_BUDGET_TRACKER_BIGQUERY_KEY_FILE";
const projectIdEnvironmentVariable =
  "EXPENSE_BUDGET_TRACKER_BIGQUERY_PROJECT_ID";
const locationEnvironmentVariable =
  "EXPENSE_BUDGET_TRACKER_BIGQUERY_LOCATION";
const maximumBytesBilledEnvironmentVariable =
  "EXPENSE_BUDGET_TRACKER_BIGQUERY_MAXIMUM_BYTES_BILLED";
