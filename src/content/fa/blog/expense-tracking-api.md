...
نقطهٔ شروع عمومی، [سند شناسایی ⁦Expense Budget Tracker⁩](https://api.expense-budget-tracker.com/v1/) است. این سند روند فعلی احراز هویت را توضیح می‌دهد، به [مشخصات ⁦OpenAPI⁩](https://api.expense-budget-tracker.com/v1/openapi.json) پیوند می‌دهد و به اسکریپت یا عامل می‌گوید در مرحلهٔ بعد کدام مسیر را فراخوانی کند.
...
[مرجع ⁦API⁩](/fa/docs/api/) جزئیات مسیرها را توضیح می‌دهد و [راهنمای راه‌اندازی عامل](/fa/docs/agent-setup/) روند ورود با کد ایمیلی را قدم‌به‌قدم نشان می‌دهد. اگر هرکدام با پاسخ فعلی سند شناسایی یا ⁦OpenAPI⁩ تفاوت داشت، قرارداد فعلی سرویس را مبنا قرار دهید.
