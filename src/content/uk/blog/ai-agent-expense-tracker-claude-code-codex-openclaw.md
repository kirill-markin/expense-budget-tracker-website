...
Відповідь повідомляє, що починати треба із `send_code`, містить початкову URL-адресу авторизації на домені авторизації та посилання на runtime-схему й відкритий вихідний код реалізації.
