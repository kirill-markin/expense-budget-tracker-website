...
description: "دليل عملي لاستخدام الذكاء الاصطناعي في إدارة المال الشخصي. امنح وكيلك مفتاح API ليقرأ الكشوف البنكية، ويصنّف المعاملات، ويتتبّع المصروفات، ويدير ميزانيتك عبر SQL API."
date: "2026-03-05"
---
...
والفكرة نفسها تعمل مع [Claude Code](https://docs.anthropic.com/en/docs/claude-code) و[OpenAI Codex](https://openai.com/index/codex/) ونسخ GPT المخصّصة، أو مع أي وكيل ذكاء اصطناعي يستطيع استدعاء نقاط نهاية عبر HTTP. العنصر الحاسم هنا هو الوصول المباشر إلى قاعدة البيانات، لا إضافة للمتصفح ولا تكامل خاص، بل مفتاح API يتيح للذكاء الاصطناعي قراءة بياناتك المالية والكتابة فيها.

## كيف تربط وكيل الذكاء الاصطناعي ببياناتك المالية

[Expense Budget Tracker](https://expense-budget-tracker.com/ar/) هو نظام مفتوح المصدر لإدارة المال الشخصي مبني على Postgres. ويوفر نقطة SQL API على المسار `POST /v1/sql` تستقبل استعلامات SQL عبر HTTP وتعيد النتائج بصيغة JSON.

ولربط أي وكيل ذكاء اصطناعي بهذا النظام:

1. افتح التطبيق، ثم من داخل الواجهة انتقل إلى **Settings → API Keys → Create key**
2. انسخ المفتاح، إذ يبدأ بـ `ebt_` ولن يظهر لك إلا مرة واحدة
3. مرّر إلى وكيل الذكاء الاصطناعي معلومتين: عنوان نقطة النهاية والمفتاح
...
2. من داخل التطبيق انتقل إلى **Settings → API Keys → Create key** ثم انسخ المفتاح
3. أعطِ الوكيل المفتاح ومعرّف مساحة العمل ونقطة النهاية `https://api.expense-budget-tracker.com/v1/sql`
4. ضع كشفًا بنكيًا داخل الوكيل واطلب منه أن يقرأ مصروفاتك ويسجلها
