...
نقطة الدخول العامة هي [وثيقة اكتشاف Expense Budget Tracker](https://api.expense-budget-tracker.com/v1/). تصف الوثيقة مسار المصادقة الحالي، وتربط بـ [مواصفة OpenAPI](https://api.expense-budget-tracker.com/v1/openapi.json)، وتخبر البرنامج النصي أو الوكيل بما يجب استدعاؤه بعد ذلك.
...
يفيد [مرجع API](/ar/docs/api/) في معرفة تفاصيل نقاط النهاية، ويشرح [دليل إعداد الوكيل](/ar/docs/agent-setup/) مسار رمز البريد الإلكتروني. إذا اختلف أي منهما عن استجابة الاكتشاف المباشرة أو استجابة OpenAPI، فاتبع العقد المباشر.
