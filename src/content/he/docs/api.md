...
תגובת הגילוי מסבירה לסוכנים איך להתחיל את תהליך האימות ולאילו נקודות קצה לפנות אחר כך. היא גם מקשרת ל-README ולקוד המקור של המימוש. ה-API חושף:
...
- `GET /v1/openapi.json` ו-`GET /v1/swagger.json` — נקודות בדיקת תאימות לגילוי קוד המקור, לא מפרטי API
