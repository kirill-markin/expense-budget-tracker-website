...
Ответ сообщает, что сначала нужно вызвать `send_code`, содержит стартовый URL на auth-домене и указывает на runtime-схему и ссылки на открытый исходный код реализации.
